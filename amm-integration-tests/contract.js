const SecretNetworkContract = require("@hackbg/integra").SecretNetworkContract
...
class FactoryContract extends SecretNetworkContract { 
    static async instantiate (say, lp_token_contract, pair_contract) {
        const name = 'amm-factory'
        const binary = `${name}.wasm`
